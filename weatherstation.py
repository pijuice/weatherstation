...
def SendMessage(LightReading,GasReading,TempReading,HumidityReading):
	...
	SMS = "Light = " + str(float(LightReading)) + "%, Gas = " +str(float(GasReading)) +"%, Temp = " + str(float(TempReading)) + "C"
	port.write("AT\r")
...
# send results to phone in SMS
	...
	print("Light Voltage: {}V, Light level: {}%". format(light_volts,light_percentage))
